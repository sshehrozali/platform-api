...
public class PulumiRunner {
    ...
    public PulumiRunner(InfrastructureCode infrastructureCode) {
        this.infrastructureCode = infrastructureCode;
    }

    public void createGKECluster(String clusterName, String computeFamily, Integer nodeCount, String createdBy) {
        runner.submit(() -> {
